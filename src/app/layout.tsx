...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`min-h-screen bg-white dark:bg-dark-800 ${geistSans.variable} ${geistMono.variable} ${montserrat.variable} ${exo2.variable} ${inter.variable} antialiased`}>
        <ThemeProvider>
          {children}
        </ThemeProvider>
      </body>
